...
# todo
- SEO
  - pre-allocate space for images. see https://web.dev/optimize-cls/?utm_source=lighthouse&utm_medium=devtools#images-without-dimensions
    - minimise cumulative layout shift (CLS)
- lazy loading: https://web.dev/fast/#lazy-load-images-and-video
  - be careful: https://developers.google.com/search/docs/guides/lazy-loading
- update dates, filenames, folders etc.
- branch deploy
...
![front of the camera on a tripod](/yyyy_mouse/camera_front.webp)
![back of the camear on a tripod](/yyyy_mouse/camera_back.webp)
![IR spotlight](/yyyy_mouse/ir_spotlight.webp)
...
![cable barrier, from the top](/yyyy_mouse/cable_mouse_barrier_top.webp)
![cable barrier, from underneath](/yyyy_mouse/cable_mouse_barrier_bottom.webp)
...
![mouse trap](/yyyy_mouse/trap.webp)
![inside the mouse trap](/yyyy_mouse/trap_inside.webp)
...
![mouse with a piece of cheese](/yyyy_mouse/mouse_with_cheese.webp)
...
![cardboard taped to wooden panel](/yyyy_mouse/wood_panel_barrier.webp)
